...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String picture = values.getAsString(InventoryEntry.COLUMN_INVENTORY_PICTURE);
        ...
        String phone = values.getAsString(InventoryEntry.COLUMN_INVENTORY_SUPPLIER_PHONE);
